...
module Slack
	module Post
		...
		KnownConfigParams = [:username,:channel,:subdomain,:token,:icon_url,:icon_emoji,:parse,:unfurl_links,:unfurl_media,:link_names,:mrkdwn].freeze
		AttachmentParams = [:fallback,:text,:pretext,:color,:fields,:mrkdwn_in].freeze
